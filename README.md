...
I coded the game for myself so I can understand the functions aspects of the game and make developing the intelligent agents easier. It was accomplished using modules from [three.js](https://threejs.org/). The game can be accessed [here](https://snakecatch.blob.core.windows.net/$web/index.html) and click **PLAY** (manual)
